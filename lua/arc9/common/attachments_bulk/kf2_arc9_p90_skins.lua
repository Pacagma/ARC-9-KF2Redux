...
ATT.Category = {"kf2_skins_p90"} -- Change this to point what weapon it is for.
ATT.Material = "skins/kf2/p90/Vault_Vosh_P90_1P" -- Change this to point where the custom skin is.

ARC9.LoadAttachment(ATT, "kf2_p90_skin_vaultdosh") -- Change this to give the skin attach a name so the base loads it.
------------------------------------------------------------------