...
SWEP.Description = [[The Desert Eagle is the beast of hand guns, which is why we all know it as the 'Hand Cannon'.]]

SWEP.ViewModel = "models/pacagma/KF2Weapons/pistols/deagle/deagle.mdl"
...
SWEP.WorldModelMirror = "models/pacagma/KF2Weapons/pistols/deagle/deagle.mdl"
...
SWEP.ImpactForce = 30 -- Stumble Power
...
SWEP.Attachments = {
    {
        ...
        Category = 
    {
        "KF2.Perks.Elite.Reload.Deagle",
    }
    },
    {

        PrintName = "Skins",
        Category = "kf2_skins_deagle",
        CosmeticOnly = true,
    },
}